...
const stories = [
  {
    slug: 'story_1',
    title: <span>{'\u3000'}富士山{'\u3000'}2025.2.14</span>,
    description: <span>{'\u3000'}{'\u3000'}朋友从国内飞来日本，我们在东京转了两天后，2月14日这一天，来到了富士山。这一天的富士山不像上次我来一样，遮遮掩掩。这一天阳光很好，我们在河口湖旁的咖啡店待了很久。</span>,
    cover: '/stories/story_1/cover.jpg',
  },
  {
    slug: 'story_2',
    title: <span>{'\u3000'}故宫{'\u3000'}2024.2.25</span>,
    description: <span>{'\u3000'}{'\u3000'}上一次来故宫只用了两个半小时就走完了中轴线，这次和她一起，也是两个半小时，希望下次会逛的更久一些。故宫那么大，还有很多地方没有看。</span>,
    cover: '/stories/story_2/cover.jpg',
  },
  {
    slug: 'story_3',
    title: <span>{'\u3000'}诺贝尔{'\u3000'}2024年的某一天</span>,
    description: <span>{'\u3000'}{'\u3000'}发现贝贝的那一天，她急匆匆给我打电话，在车底把他捞了出来。从此在她心里我变成了下一位。</span>,
